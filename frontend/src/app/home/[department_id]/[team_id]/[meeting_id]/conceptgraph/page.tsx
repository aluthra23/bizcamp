...
const ConceptNodeComponent = ({ data }: { data: any }) => {
    ...
    return (
        <div className={`px-2 py-1.5 rounded-lg border border-white/20 max-w-[130px] bg-gradient-to-br ${nodeColorClass}`}>
    ...
    const processGraphForReactFlow = (graph: ConceptGraph) => {
        ...
        const simpleEdges = graph.edges.map((edge, index) => {
            return {
                ...
                source: edge.source,
                target: edge.target,
                // Important: remove type specification to use default edges
                label: edge.type,
                style: {
                                            ...
                                            .map((node) => (
                                                ...
                                                >
                                                    <div className="flex items-center gap-3 mb-2">
                                                        <div className={`w-8 h-8 rounded-full bg-gradient-to-br ${getNodeColor(node.type)} flex items-center justify-center text-white font-bold text-sm`}>
                                                            {node.importance}
                                                        </div>
                                                        <div>
                                ...
                                <div className="md:w-2/3">
                                    ...
                                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 px-4 py-4 bg-white/5 rounded-lg border border-white/10">
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-sm text-white/80">Related</span>
                                        </div>
                                        <div className="flex items-center gap-2">
                                            <div className="h-0.5 w-8 bg-violet-500"></div>
                                            <span className="text-sm text-white/80">Subtopic</span>
                                        </div>
                                        <div className="flex items-center gap-2">
                                            <div className="h-0.5 w-8 bg-emerald-500"></div>
                                            <span className="text-sm text-white/80">Implies</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            {getRelatedNodes(selectedNode).map(relatedNode => {
                                                ...
                                                return (
                                                    <div key={relatedNode.id} className="p-4 bg-white/5 rounded-lg border border-white/10">
                                                        <div className="flex items-center gap-3 mb-2">
                                                            <div className={`w-8 h-8 rounded-full bg-gradient-to-br ${getNodeColor(relatedNode.type)} flex items-center justify-center text-white font-bold text-sm`}>
